...
class AddingCenterView extends StatelessWidget {
  AddingCenterView({Key? key}) : super(key: key);
  AddingCenterControllerImp addingCenterControllerImp =
      Get.put(AddingCenterControllerImp());
  @override
